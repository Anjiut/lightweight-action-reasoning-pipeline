...
# Directory of extracted frames (from new/test videos)
FRAME_DIR = "new_frames"

# Directory to save pose keypoints for new/test videos
POSE_DIR = "new_pose_keypoints"
...
print("[INFO] Extracting pose keypoints for NEW videos...")
...
for action in actions:
    ...
    for frame_name in frame_files:
        ...
        # OpenPifPaf inference (same API as training pose extraction)
        ...
        if predictions:
            ...
            # If no person is detected in this frame, store None
            keypoints = None
...
print("\n[INFO] All poses extracted successfully for NEW videos!")
